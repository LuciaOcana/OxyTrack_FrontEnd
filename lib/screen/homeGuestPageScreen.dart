...
class HomeGuestPageScreen extends StatefulWidget {
  const HomeGuestPageScreen({super.key});

  @override
  State<HomeGuestPageScreen> createState() => _HomeGuestPageScreenState();
}
...
class _HomeGuestPageScreenState extends State<HomeGuestPageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final graphColor = isLight ? const Color(0xFF0096C7) : const Color(0xFF90E0EF);
    final lastRegsColor = isLight ? Color(0xFF00B4D8) : const Color.fromARGB(255, 154, 148, 148);

    String formattedTime =
        lastTimestamp != null ? DateFormat('HH:mm:ss').format(lastTimestamp!) : '--:--:--';
      ...
      body: Column(
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 48, fontWeight: FontWeight.bold, color: graphColor),
          ),
          const SizedBox(height: 5),
          Text('Último registro: $formattedTime', style: TextStyle(fontSize: 16, color: lastRegsColor)),
            ...
            child: Padding(
              ...
              child: SfCartesianChart(
                title: ChartTitle(
                  ...
                  textStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: graphColor),
                ),
                plotAreaBorderColor: graphColor.withOpacity(0),
                ...
                primaryYAxis: NumericAxis(
                  ...
                  maximum: 100,
                  labelFormat: '{value}%',
                  majorGridLines: MajorGridLines(width: 2.5, color: graphColor.withOpacity(0.2)),
                ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(
          ...
          style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'OpenSans', color: textColor),
        ),
        content: Text(
